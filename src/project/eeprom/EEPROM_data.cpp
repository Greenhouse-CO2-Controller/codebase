...
// Function-local static ensures construction occurs on first call (task context) -Chedel
EEPROM_data& Settings() {
    static EEPROM_data instance;   // ctor reads EEPROM once
    return instance;
}

const uint16_t getCO2Setpoint(); // -Chedel
